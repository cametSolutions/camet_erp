...
function EditCreditNote() {
  ...
  const additionalChargesFromRedux = useSelector(
    (state) => state.creditNote.additionalCharges
  );
  ...
  const creditNoteDetailsFromRedux = useSelector((state) => state.creditNote);
  ...
  const party = useSelector((state) => state.creditNote.party);
  ...
  const submitHandler = async () => {
    ...
    try {
      ...
      navigate(`/sUsers/creditDetails/${id}`);
      dispatch(removeAll());
    } catch (error) {
