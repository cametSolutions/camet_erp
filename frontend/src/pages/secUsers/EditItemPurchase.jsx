...
function EditItemPurchase() {
  ...
  const handleBackClick = () => {
    ...
    // if (location.state.id && location.state.from == "addItemPurchase") {
    //   console.log("haii");
    //   navigate("/sUsers/addItemPurchase", {
    //     state: { from: "editPurchase", id: location.state.id },
    //   });
    // } else if (location.state.from === "purchase") {
    //   console.log("haii");

    //   navigate("/sUsers/purchase");
    // } else if (location?.state?.from === "addItemPurchase") {
    //   console.log("haii");

    //   navigate("/sUsers/addItemPurchase");
    // } else if (location?.state?.from === "editPurchase") {
    //   console.log("haii");
  ...
  const changeModalCount = (event,index, value) => {
    ...
    console.log(value);
    console.log(newGodownItems);
    currentGodown.balance_stock = currentGodown.orginalStock + Number(value);
