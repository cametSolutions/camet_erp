          ...
          <div className="sticky top-0 z-50">
            ...
            >
              ...
              <div
                className={`   text-center  text-white  flex justify-center items-center flex-col mt-5`}
              >
                <h2 className="text-3xl sm:text-4xl font-bold">₹3000</h2>
                <p className="text-sm mt-4 font-semibold opacity-90">
                  {new Date(start).toDateString()} -{" "}
                  {new Date(end).toDateString()}
                </p>
                ...
                <div className="mt-2 p-3">
                  {summaryReport &&
                    ...
                    summaryReport?.map((item, index) => (
                      <div
                        key={index}
                        className="flex justify-between items-center mb-2 p-3 py-5 bg-white shadow-md transform transition duration-300 cursor-pointer  hover:-translate-y-[1px]"
                      >
                        <span className="text-gray-800 font-medium">
                          {item?.partyName ||
                            item?.groupName ||
