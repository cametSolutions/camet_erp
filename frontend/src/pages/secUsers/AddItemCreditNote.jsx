...
import { addItem, removeItem } from "../../../slices/creditNote";
import { useDispatch } from "react-redux";
import { setPriceLevel } from "../../../slices/creditNote";
import {
  changeTotal,
  setBrandInRedux,
  setCategoryInRedux,
...
function AddItemCreditNote() {
  ...
  const itemsFromRedux = useSelector((state) => state.creditNote.items);
  ...
  const allProductsFromRedux =
    useSelector((state) => state.creditNote.products) || [];

  ///////////////////////////filters FromRedux///////////////////////////////////

  const brandFromRedux =
    useSelector((state) => state.creditNote.brand) || "";
  const categoryFromRedux =
    useSelector((state) => state.creditNote.category) || "";
  const subCategoryFromRedux =
    useSelector((state) => state.creditNote.subcategory) || "";
...
export default AddItemCreditNote;
