...
import { addItem, removeItem } from "../../../slices/debitNote";
import { useDispatch } from "react-redux";
import { setPriceLevel } from "../../../slices/debitNote";
import {
  changeTotal,
  setBrandInRedux,
  setCategoryInRedux,
...
function AddItemDebitNote () {
  ...
  const itemsFromRedux = useSelector((state) => state.debitNote.items);
  ...
  const allProductsFromRedux =
    useSelector((state) => state.debitNote.products) || [];
  ...
  const subCategoryFromRedux =
    useSelector((state) => state.debitNote.subcategory) || "";
