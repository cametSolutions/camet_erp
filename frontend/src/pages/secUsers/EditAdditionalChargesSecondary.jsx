...
function EditAdditionalChargesSecondary() {
  ...
  const submitHandler = async () => {
    ...
    try {
      const res = await api.post(
        `/api/sUsers/EditAditionalCharge/${cmp_id}/${id}`,
        formData,
        {
          headers: {
    ...
    <div className="flex">
      ...
      <div className=" flex-1 h-screen overflow-y-scroll">
        <div className="bg-[#201450] sticky top-0 p-3 z-100 text-white text-lg font-bold flex items-center gap-3 z-20">
          ...
          onClick={()=>{navigate('/sUsers/additionalChargesList')}}
...
export default EditAdditionalChargesSecondary;
