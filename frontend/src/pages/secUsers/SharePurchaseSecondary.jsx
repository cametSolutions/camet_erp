...
function SharePurchaseSecondary() {
  ...
  const handlePrint = useReactToPrint({
    ...
    documentTitle: data.purchaseNumber
      ? `${data.purchaseNumber}_${data._id.slice(-4)}`
      : "Purchase_Order",
    pageStyle: `
      @page {
        size: A4;
  ...
  useEffect(() => {
    if (!loading && data.purchaseNumber && contentToPrint.current) {
  ...
  }, [loading, data.purchaseNumber, handlePrint]);
...
export default SharePurchaseSecondary;
