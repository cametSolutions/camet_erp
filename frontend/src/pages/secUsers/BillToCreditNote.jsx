...
import { addNewAddress } from "../../../slices/creditNote";

function BillToCreditNote() {
  const dispatch = useDispatch();
  const navigate = useNavigate();

  const partyDetails = useSelector((state) => state.creditNote.party);
  const newBillToShipTo =
    useSelector((state) => state.creditNote.party.newBillToShipTo) || {};
...
export default BillToCreditNote;
