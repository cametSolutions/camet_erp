...
const StatCard = ({
  ...
  const DetailIcon = ({ type }) => {
    ...
    if (type === "bank") {
      return (
        ...
        >
          <path
            d="M3 10h18M3 10V20h18V10M3 10L12 3l9 7"
            stroke="currentColor"
            strokeWidth="1.8"
            strokeLinejoin="round"
          />
  ...
  return (
    ...
    >
      ...
      {/* Subtitle */}
      <p className="text-[10px] sm:text-[11px] text-white/55 z-10 mt-1">
        {subtitle}
      </p>
        ...
        <div className="z-10 mt-3 pt-3 border-t border-white/20 flex items-center justify-between gap-2 sm:gap-3">
          <div className="min-w-0">
            <div className="flex items-center gap-1 text-white/80">
              ...
              <p className="text-[8px] sm:text-[9px] text-white uppercase tracking-wider leading-none">
                {cashLabel}
              </p>
            </div>
