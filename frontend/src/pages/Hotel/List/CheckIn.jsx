...
const CheckInList = () => {
 ...
 const [startDate, setStartDate] = useState('');
  ...
  const filteredCheckIns = checkIns.filter(checkIn => {
    const matchesSearch = checkIn.guestName.toLowerCase().includes(searchTerm.toLowerCase()) ||
      ...
      <div className="max-w-full mx-auto">
            ...
            <table className="w-full text-sm">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Tariff Rate</th>
                  ...
                  <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Food Plan Amount</th>
                  ...
                  <th className="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Booking Advance</th>
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredCheckIns.map((checkIn, index) => (
                  <tr key={checkIn.id} className={index % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                    ...
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900 font-medium">{checkIn.guestName}</td>
                    ...
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{formatDate(checkIn.arrivalDate)}</td>
                    ...
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{formatDate(checkIn.checkoutDate)}</td>
                    {/* <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">
                      <div className="flex items-center gap-1">
                        <Clock className="h-3 w-3 text-gray-400" />
                    ...
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{checkIn.noOfPax}</td>
                    {/* <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{checkIn.extraPaxType}</td> */}
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{formatCurrency(checkIn.extraPaxRate)}</td>
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{formatCurrency(checkIn.extraPaxAmount)}</td>
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{checkIn.totalExtraPax}</td>
                    {/* <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{checkIn.plan}</td> */}
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{formatCurrency(checkIn.planAmount)}</td>
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{formatCurrency(checkIn.tarifRate)}</td>
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-green-600 font-medium">{formatCurrency(checkIn.roomRent)}</td>
                    ...
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900 font-medium">{formatCurrency(checkIn.amount)}</td>
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{formatCurrency(checkIn.foodPlanAmount)}</td>
                    ...
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-blue-600 font-bold">{formatCurrency(checkIn.totalBillAmount)}</td>
                    {/* <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{checkIn.sourceType}</td> */}
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{formatCurrency(checkIn.bookingAdvance)}</td>
                    {/* <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{checkIn.advanceDetails}</td> */}
                    <td className="px-3 py-4 whitespace-nowrap text-sm text-gray-900">{checkIn.enteredBy}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        {filteredCheckIns.length === 0 && (
          <div className="bg-white rounded-lg shadow-lg p-8 text-center mt-6">
            <div className="text-gray-500 text-lg">No check-ins found matching your criteria.</div>
          </div>
        )}
