                      ...
                      {[
                        ...
                        >
                          <div className="relative">
                            <FaCircle
                              className={`text-${color}-500 text-sm animate-pulse`}
                            />
                            <div
                              className={`absolute inset-0 bg-${color}-500 rounded-full animate-ping opacity-20`}
                            />
                          </div>
                          <span
                            className={`text-sm font-medium text-gray-700 group-hover:text-${color}-600 transition-colors`}
                          >
                            {label}
                          </span>
                        </div>
                  ...
                  {/* {taggedParent && (
                    <div className="flex items-center gap-2 px-3 py-1.5 bg-indigo-50 border border-indigo-200 rounded-lg">
                      ...
                      <button
                        ...
                        className="ml-1 p-0.5 rounded-full hover:bg-indigo-200 text-indigo-400 hover:text-indigo-600 transition-colors"
                      >
                        <X className="w-3 h-3" />
                      </button>
                    </div>
                            ...
                            <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
                              <div className="bg-white rounded-2xl shadow-lg w-96 p-6 space-y-4">
                                ...
                                <p className="text-sm text-gray-600">
                                  Choose to continue with payment or post the
                                  bill to the room.
                                </p>
