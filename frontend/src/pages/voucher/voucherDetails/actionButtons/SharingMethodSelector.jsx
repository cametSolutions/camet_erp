...
import { MdPrint, MdEmail } from "react-icons/md";
import { FaWhatsapp } from "react-icons/fa";

export function SharingMethodSelector({ open, setOpen, handlePrint }) {
  const [selectedMethod, setSelectedMethod] = useState("print");
