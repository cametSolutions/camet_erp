...
import VoucherPdfHeaderNonIndian from "./VoucherPdfHeaderNonIndian";
import VoucherPdfFooterNonIndian from "./VoucherPdfFooterNonIndian";

function VoucherPdfNonIndian({ data, org, contentToPrint, bank, tab }) {
...
export default VoucherPdfNonIndian;
