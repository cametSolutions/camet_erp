...
function VoucherPdfFooterNonIndian({
  bank,
  org,
  data,
  additinalCharge,
    ...
    <div className="mb-5">
      ...
      <div className="flex justify-between items-start mt-3 ">
        ...
        {configurations?.showTaxAnalysis ? (
          <TaxTable products={data?.items} org={org} party={party} isIndian={false} />
        ) : (
          <div></div>
        )}
          ...
          {configurations?.showTaxAmount &&
            (() => {
              ...
              return isSameState ? (
                ...
                <div className="flex flex-col items-end text-[9px] text-black font-bold gap-1 mt-3">
                  {totalTax > 0 && <p>Vat : {totalTax.toFixed(2)}</p>}
                </div>
              );
            })()}
...
export default VoucherPdfFooterNonIndian;
