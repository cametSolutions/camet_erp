            ...
            >
                    ...
                    {[
                      ...
                      },
                      {
                        ...
                        value: `${new Date(
                          ...
                          month: "long",
                          year: "numeric",
                        })} to  ${new Date(item?.Warrantyto).toLocaleDateString(
                          "en-GB",
                          {
                            day: "2-digit",
                            month: "long",
              ...
              <div className="mt-14 mb-8 flex justify-end w-full ">
                <div className="border w-2/5 border-black h-24 flex items-start justify-center pb-2">
                  <span className="text-xs mt-2">Dealer Signature (Stamp)</span>
                </div>
              </div>
              ...
              <div className="mt-8">
                ...
                <p className="text-xs ">
                  This warranty is valid for manufacturing defects and repair of
                  your appliance within warranty period at the date of purchase.
                  Service will be provided within 15 days once the product goes
                  to dysfunctional. The warranty stand void if the product, is
                  tampered with or not used in accordance with the operating
                  terms specified by the manufacturer. Warranty does not cover
                  any physical or liquid damage (including any damage caused due
                  to natural calamities like earth quake, cyclone, voltage
                  fluctuations, lighting natural pouring) wear & tear 1-3 month
                  warranty for TV remote typically covers (physical damage not
                  covered under warranty).The accessories are not covered in
                  this warranty. If the Product Serial number is altered or
                  removed, warranty is void.
                </p>
              </div>
