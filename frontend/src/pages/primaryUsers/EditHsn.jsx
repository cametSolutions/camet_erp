...
function EditHsn() {
  ...
  return (
    <div className="">
      <div className="bg-[#012A4A] cursor-pointer sticky top-0 p-3 z-100 text-white text-lg font-bold flex items-center gap-3 z-20">
        <IoIosArrowRoundBack
        onClick={() => navigate(-1)}
                  ...
                  <>
                    ...
                    <div className="ml-1">
                      <button
                        ...
                        disabled={
                          rows.length === 0 || rows[rows.length - 1].upto === ""
                        }
