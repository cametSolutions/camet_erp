...
import {
  ...
  findSecondaryUserGodowns,
  findPrimaryUserGodownsSelf,
  godownwiseProducts,
  godownwiseProductsSelf,
  findGodownsNames,
  getAllSubDetails,
  fetchGodowns,
...
import {
  ...
  deleteProductSubDetails,
  editProductSubDetails,
  addProductSubDetails,
  addHsn,
  getSingleHsn,
  editHsn,
  deleteHsn,
...
import {
  ...
  editBarcodeData,
  deleteBarcode,
  getSingleBarcodeData,
  getPrintingConfiguration,
  updateConfiguration,
  getDespatchTitles,
  updateDespatchTitles,
...
router.get(
  "/fetchOutstandingDetails/:party_id/:cmp_id",
  authSecondary,
  secondaryIsBlocked,
  companyAuthentication,
  fetchOutstandingDetails
...
router.delete(
  "/deleteAdditionalCharge/:id/:cmp_id",
  authSecondary,
  secondaryIsBlocked,
  companyAuthentication,
  deleteAdditionalCharge
...
router.get(
  "/fetchConfigurationNumber/:cmp_id/:title",
  authSecondary,
  secondaryIsBlocked,
  companyAuthentication,
  fetchConfigurationNumber
...
router.get(
  "/godownProductFilter/:cmp_id/:godown_id",
  authSecondary,
  companyAuthentication,
  secondaryIsBlocked,
  godownwiseProducts
...
router.get(
  "/godownProductFilterSelf/:cmp_id/:godown_name",
  authSecondary,
  secondaryIsBlocked,
  companyAuthentication,
  godownwiseProductsSelf
...
router.post(
  "/cancelReceipt/:receiptId/:cmp_id",
  authSecondary,
  secondaryIsBlocked,
  cancelReceipt
)
...
router.post(
  "/cancelPayment/:paymentId/:cmp_id",
  authSecondary,
  secondaryIsBlocked,
  cancelPayment
)
...
router.post(
  "/addProductSubDetails/:orgId",
  authSecondary,
  secondaryIsBlocked,
  addProductSubDetails
)
router.get(
  "/getProductSubDetails/:orgId",
  authSecondary,
  secondaryIsBlocked,
  getProductSubDetails
)
router.delete(
  "/deleteProductSubDetails/:orgId/:id",
  authSecondary,
  secondaryIsBlocked,
  deleteProductSubDetails
)
router.put(
  "/editProductSubDetails/:orgId/:id",
  authSecondary,
  secondaryIsBlocked,
  editProductSubDetails
)
...
router.get(
  "/findSourceTransactions/:cmp_id/:id",
  authSecondary,
  secondaryIsBlocked,
  companyAuthentication,
  findSourceTransactions
...
router.delete(
  "/getSingleBarcodeData/:id/:cmp_id",
  authSecondary,
  secondaryIsBlocked,
  companyAuthentication,
  getSingleBarcodeData
...
router.get(
  "/getPrintingConfiguration/:cmp_id",
  authSecondary,
  secondaryIsBlocked,
  companyAuthentication,
  getPrintingConfiguration
...
router.put(
  "/updateTermsAndConditions/:cmp_id",
  authSecondary,
  secondaryIsBlocked,
  companyAuthentication,
  updateTermsAndConditions
